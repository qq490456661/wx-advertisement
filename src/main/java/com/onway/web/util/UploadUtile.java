        ...
        if (!file.isEmpty()) {
            try {
                ...
                if(num=="0"){
                    ...
                    String path="http://118.178.135.106:8098/images/QuickMark/"+String.valueOf(day)+"/"+fileName;
//                    String path="../../images/QuickMark/"+String.valueOf(day)+"/"+fileName;
                    ...
                    String path="http://118.178.135.106:8098/images/BottomAd/"+String.valueOf(day)+"/"+fileName;
//                    String path="../../images/BottomAd/"+String.valueOf(day)+"/"+fileName;
                    ...
                    String path="http://118.178.135.106:8098/images/FullAd/"+String.valueOf(day)+"/"+fileName;
